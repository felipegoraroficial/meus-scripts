...
desp_autoschema = spark.read.load("dados/despachantes.csv",
...
despachantes.write.format("parquet").save("dados/dfimportparquet")
despachantes.write.format("csv").save("dados/dfimportcsv")
despachantes.write.format("json").save("dados/dfimportjson")
despachantes.write.format("orc").save("dados/dfimportorc")

#ler dados
par = spark.read.format("parquet").load("dados/despachantes.parquet")
par.show()
par.schema()

js = spark.read.format("json").load("dados/despachantes.json")
js.show()
js.schema()

or = spark.read.format("orc").load("dados/despachantes.orc")
or.show()
or.schema()
